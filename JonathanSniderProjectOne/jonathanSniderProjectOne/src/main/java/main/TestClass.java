...
public class TestClass {
	...
	public static void main(String[] args) {
		...
		// testReimburse.getReimbursements();
		 //testUtil.getEmployees();
		 //testEmployee.removeEmployee(6);
		 //testEmployee.insertEmployee("Wendy", "O'Koopa", 2, false, "Cook", 1250.45, "Wendy", "KoopaKid6");
		 //testReimburse.removeReimbursement(5);
