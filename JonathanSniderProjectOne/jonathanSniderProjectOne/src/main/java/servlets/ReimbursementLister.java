...
/**
 * Servlet implementation class ReimbursementLister
 */
public class ReimbursementLister extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public ReimbursementLister() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<Reimbursement> reimbursements= ue.getReimbursementsById(employeeId);
